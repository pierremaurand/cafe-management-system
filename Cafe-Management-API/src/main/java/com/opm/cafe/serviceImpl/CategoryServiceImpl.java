...
import com.opm.cafe.service.CategoryService;
...
public class CategoryServiceImpl implements CategoryService {
    ...
    public ResponseEntity<String> addNewCategory(Map<String, String> requestMap) {
        try {
            if(jwtFilter.isAdmin()) {
                if(validateCategoryPap(requestMap, false)) {
    ...
    public ResponseEntity<String> updateCategory(Map<String, String> requestMap) {
        try {
            if(jwtFilter.isAdmin()) {
                if(validateCategoryPap(requestMap, true)) {
    ...
    private Boolean validateCategoryPap(Map<String, String> requestMap, boolean validateId) {
